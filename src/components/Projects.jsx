...
const projectVariants = {
    hidden: {
        opacity: 0, scale: 0, rotate: -40, y: 50
    },
    visible: {
        opacity: 1,
        scale: 1,
            ...
            {PROJECTS.map((project, index) => (
                ...
                variants={projectVariants}>
                    ...
                    <div className='flex flex-col justify-between'>
                        ...
                        <a href='https://github.com/mariwan001'
                        target='_blank'
                        rel='noopener noreferrer'
                        className='bg-white text-stone-900 rounded-full py-2 px-2 w-32 text-sm hover:bg-gray-100 text-center'>View On Github</a>
                    </div>
                    </div>
                </motion.div>
            ))}
